...
const TourCard = ({ tour }) => {
  ...
  return (
    <div
      ...
      className={`bg-white/80 backdrop-blur-sm border border-orange-300 rounded-3xl shadow-lg p-6 flex flex-col cursor-pointer 
        hover:shadow-orange-300 transition-all duration-300 min-w-[300px]
        ${expanded ? "scale-105" : ""}`}
    ...
    >
      ...
      />
      <h2 className="text-2xl font-bold text-orange-700 mb-2">{tour.title}</h2>
      
      {/* Always show these main details */}
      ...
      {expanded && (
        <>
          <div className="mb-3">
            <p className="font-semibold text-orange-700">🗓 Itinerary:</p>
          ...
          <div className="mt-6 flex space-x-4">
            ...
            >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M16.88 7.41a5.5 5.5 0 11-7.78 7.78L6 21l3.81-1.03a5.5 5.5 0 006.07-12.56z" />
              </svg>
              <span>WhatsApp</span>
            </a>
            ...
            >
              {/* Email Icon */}
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M16 12H8m0 0l-4-4m4 4l4 4m8-12v12a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2h12z" />
              </svg>
              <span>Email</span>
            </a>
          </div>
