      ...
      <section className="max-w-[1400px] mx-auto">
        ...
        {message && (
          <div
            ...
            style={{
              backgroundColor:
                messageType === 'success' ? accent : primary,
            }}
          >
            {message}
          </div>
        ...
        {/* Form */}
        <div
          className="mx-auto max-w-lg sm:max-w-xl bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-10 shadow-xl border"
          style={{ borderColor: accent }}
        >
          <h2
            className="text-2xl sm:text-3xl font-extrabold mb-6 sm:mb-10 text-center drop-shadow-md"
            style={{ color: accent }}
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
            ...
            {['name', 'email', 'phone'].map((id) => (
              <div key={id}>
                ...
                <input
                  ...
                  className="w-full rounded-lg border px-3 sm:px-4 py-2 sm:py-3 placeholder-opacity-60 text-gray-800 font-medium focus:outline-none focus:ring-4 transition"
                  style={{
                    borderColor: accent,
                    color: primary,
                  }}
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full rounded-lg border px-3 sm:px-4 py-2 sm:py-3 bg-white text-gray-800 focus:ring-4 transition"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-lg border px-3 sm:px-4 py-2 sm:py-3 placeholder-opacity-60 text-gray-800 font-medium resize-none focus:outline-none focus:ring-4 transition bg-white"
                style={{ borderColor: accent, color: primary }}
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full font-extrabold py-3 sm:py-4 rounded-lg sm:rounded-xl shadow-lg hover:-translate-y-1 transition-transform text-sm sm:text-base"
